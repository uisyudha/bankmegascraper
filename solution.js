...
const getData = async (category) => {
    ...
    switch (category) {
        case 'Travel':
            dataID = "travel and entertainment"
            break
        case 'Lifestyle':
            dataID = "lifestyle and wellness"
            break
        case 'Food & Beverages':
            dataID = "food and baverages"
            break
        case 'Gadget & Entertainment':
            dataID = "gadget and electronics"
            break
        case 'Daily Needs':
            dataID = "daily needs and home appliances"
            break
        case 'Others':
            dataID = "others"
            break
...
const run = async () => {
    ...
    promises = []
    await getData('Gadget & Entertainment').then(() => {
    ...
    promises = []
    await getData('Daily Needs').then(() => {
